...
If the script needs something outside your lane before it ships — a real stat from Atlas to replace `[STAT TBD]`, a long-form caption polish from King Henry, a strategic call from Professor Adrian — append a message block at the very end of your response:
...
Available agents: `atlas` (research), `king-henry` (copy/comms), `professor-adrian` (architecture), `rack` (infra).
