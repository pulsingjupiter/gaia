...
export const CONVERSATIONS: Conversation[] = [
  { id: "c1", participants: ["gaia"], preview: "I've completed the analysis...", time: "9:41 AM", pinned: true },
  { id: "c2", participants: ["nova"], preview: "Trend digest is up.", time: "8:50 AM", pinned: true },
  { id: "c3", participants: ["gaia"], preview: "Today's report ready", time: "7m" },
  ...
  { id: "c9", participants: ["gaia", "king-henry"], preview: "Carousel review", time: "5h" },
